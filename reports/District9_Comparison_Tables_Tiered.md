# District 9 — Candidate Comparison Tables by Tier
...
**Key local issues:** Population growth and density in San Ġwann/Swieqi, overdevelopment, cost of living pressures in an affluent but squeezed district, LGBTQ rights and civil liberties (relevant in D9's progressive population), and the ongoing Swieqi pedestrian footbridge controversy.
...
*Note: Full profiles for all PN and third-party notable candidates are in the District 10 report. This report includes abbreviated entries and focuses on D9-specific electoral context.*

---

## T1 — TABLE 1: POLITICAL ALIGNMENT (abbreviated — see D10 for full entries)
...
## T1 — TABLE 2: TRACK RECORD (see D10 report for full PN/third-party profiles)

| Candidate | Rating | See Also |
|---|---|---|
| **Rebecca Buttigieg** 🏛️ Gov. | ⭐⭐⭐ | D10 report |
| **Clifton Grima** 🏛️ Gov. | ⭐⭐ | D10 report |
| **Michael Falzon** 🏛️ Gov. | ⭐⭐ | D10 report |
| **Beppe Fenech Adami** | ⭐⭐⭐ | D8 report (if produced) |
| **Joe Giglio** | ⭐⭐⭐ | D10 report |
| **Graziella Attard Previ** | ⭐⭐⭐ | D10 report |
| **Albert Buttigieg** | ⭐⭐⭐ | D10 report |
| **Eve Borg Bonello** | ⭐⭐⭐ | D10 report |
| **Arnold Cassola** | ⭐⭐⭐⭐ | D10 report |
| **Mark Zerafa** | ⭐ | D1 report |

---

## T1 — TABLE 3: CONTROVERSIES (abbreviated — see D10 report for full entries)
...
| **Notable** | Rebecca Buttigieg 🏛️ Gov. | Labour | ⭐⭐⭐ | 🟢 | 📡 | ✅ Competitive |
| **Notable** | Arnold Cassola | Momentum | ⭐⭐⭐⭐ | 🟢 | 📢 | ✅ Competitive (transfers) |
| **Notable** | Mark Zerafa | ADPD | ⭐ | 🟢 | 📶 | ✗ Structural ceiling |
...
*Same as D10 Issue Stance Matrix — D9 and D10 share the same candidate blocs and issue landscape. The D9-specific context is:*

**D9-specific notes:**
- Swieqi pedestrian footbridge opposition — local residents protested against the planned footbridge over Triq Sant'Andrija (May 2026); the local council joined residents in opposition. This is a live overdevelopment/quality-of-life issue during the campaign.
- The D9 electorate is among Malta's most educated and includes a high concentration of civil society activists, professionals, and younger voters — making civil liberties, anti-corruption, and LGBTQ issues particularly salient.
- Arnold Cassola's Momentum candidacy is viable primarily through STV transfer flows; in a PN-leaning district where preference voting matters, his governance platform may pick up transfers.
- Population growth and road congestion in the San Ġwann/Swieqi corridor are acute local concerns directly linked to the broader national traffic/population issue polling at 9.0/8.0 in the KPI survey.

| Issue | Labour (PL) | PN | ADPD | Momentum | Imperium Europa / Aħwa Maltin |
|---|---|---|---|---|---|
| **EU Membership** | Strongly pro-EU | Pro-EU; EPP | Strongly pro-EU | Pro-EU | IE: hostile; AM: sovereigntist |
| **Overdevelopment** | Planning reform | ODZ enforcement; developer revolving door | Strict ODZ; moratorium | Halt permits | No position |
| **Cost of Living** | Subsidies; supplements | Tax cuts | Progressive taxation | Anti-corporate | Blame immigration |
| **LGBTQ Rights** | Full support | Accept existing legislation | Champion further | Supportive | IE/AM: opposes |
| **Abortion** | Maintains ban | Maintains ban; Borg Bonello explicitly pro-life | Pro-choice | Cassola: pro-life personal / party free vote | Anti-abortion |
| **Euthanasia** | Referendum pledged | Against | Supports | Supports debate | Against |
| **Immigration** | Managed; anti-racism | Firmer controls | Humanitarian | Balanced | IE: extreme restriction; AM: restriction |
| **Anti-Corruption** | Vitals inquiry ongoing | Anti-corruption central | Strong | Central (Cassola EPPO referrals) | Anti-establishment |
