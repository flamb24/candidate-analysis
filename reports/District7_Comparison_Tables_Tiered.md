# District 7 — Candidate Comparison Tables by Tier
...
District 7 is the central-west rural belt of Malta — Rabat, Żebbuġ, Dingli, Mdina and environs. Labour has consistently won 55–60% since 2013 (up from ~50% pre-2013). Expected split: **3 Labour / 2 PN**. In 2022 Labour took 3 seats and PN 2 (Adrian Delia and Ryan Callus — both retiring/not contesting D7 primarily in 2026).

The defining feature of D7 in 2026 is the **PN's significant candidate vacancy**: Ryan Callus is not contesting and Adrian Delia has moved primarily to D8. **Rebekah Borg** is the new PN D7 anchor. Labour's **Ian Borg** (Deputy PM, D6 and D7) is the most prominent candidate. **Naomi Cachia** (Government Whip) and **Julia Farrugia** (Inclusion Minister, D5 and D7) add ministerial weight to Labour's slate.

**Key local issues:** Overdevelopment pressures (particularly Żebbuġ and Rabat), hunting and trapping community (significant in D7), and rural heritage/planning.
...
Labour: Ian Borg, Naomi Cachia, Julia Farrugia, Silvio Schembri
...
| **Naomi Cachia** 🏛️ Gov. | Labour | S&D | Centre-left; progressive | Government Whip (first woman in role, since 2024); MP via 52A (2022–); lawyer; former FŻL president | Women's rights; parliamentary process; progressive social policy | Silent |
...
| **Silvio Schembri** | Labour | S&D | Centre-left; digital economy | Former Min. Digital Economy (2017–22); D6 and D7; Żebbuġ connections | Digital economy; enterprise; Żebbuġ community | Silent |
| **Rebekah Borg** | PN | EPP | Centre-right; environment | Shadow Min. Environment; D7 and D11; daughter of former PN figure | Environment; ODZ; rural heritage | Silent |
...
|---|---|---|---|---|---|---|
| **Notable** | Ian Borg 🏛️ Gov. | Labour | ⭐⭐⭐⭐ | 🟡 | 📢 | ✅✅✅ Near-certain (D6 primary) |
| **Notable** | Naomi Cachia 🏛️ Gov. | Labour | ⭐⭐⭐ | 🟢 | 📡 | ✅✅ Likely |
| **Notable** | Rebekah Borg | PN | ⭐⭐ | 🟢 | 📶 | ✅✅ Likely (PN primary D7) |
| **Notable** | Julia Farrugia 🏛️ Gov. | Labour | ⭐⭐⭐ | 🟡 | 📡 | ✅ Competitive (D5 primary) |
| **Notable** | Adrian Delia | PN | ⭐⭐⭐ | 🔴 | 📡 | ✅ Competitive (D8 primary) |
...
**Candidates in this tier (5):**
Labour: Malcolm Paul Agius Galea, Anthony Agius Decelis, Samantha Pace Gasan, Omar Rababah
PN: Charles Azzopardi, Andrew Agius, Paul Mazzola, Anthony Mifsud, Ian Mario Vassallo
...
| **Ian Mario Vassallo** | PN | EPP | Shadow Min. Primary Healthcare; D7 and D12 | Silent |
...
| **Anthony Agius Decelis** | MP (2022–); D7 | ⭐⭐ |
...
| **Ian Mario Vassallo** | MP (2022–); Shadow Min. Primary Healthcare; D7 and D12 | ⭐⭐ |
...
| **Second-tier** | Malcolm Paul Agius Galea 🏛️ Gov. | Labour | ⭐⭐ | 🟢 | 📶 | ✅ Possible (D6 primary) |
| **Second-tier** | Samantha Pace Gasan | Labour | ⭐ | 🟢 | 📵 | ✅ Possible (gender mechanism) |
| **Second-tier** | Omar Rababah | Labour | ⭐ | 🟢 | 📶 | ✗ Unlikely |
| **Second-tier** | Charles Azzopardi | PN | ⭐⭐ | 🟢 | 📶 | ✅ Competitive (transfers) |
| **Second-tier** | Ian Mario Vassallo | PN | ⭐⭐ | 🟢 | 📶 | ✅ Competitive |
| **Second-tier** | Andrew Agius | PN | ⭐ | 🟢 | 📵 | ✗ Unlikely |
| **Second-tier** | Paul Mazzola | PN | ⭐ | 🟢 | 📵 | ✗ Unlikely |
...
| **Hunting/Trapping** | Managed; spring hunting referendum legacy | Hunting rights protected; Bezzina portfolio | Against hunting | Against hunting | Support traditional |
| **Overdevelopment / Rural Heritage** | Planning reform pledged | ODZ; Azzopardi (heritage); Rebekah Borg (environment) | Strict ODZ; planning moratorium | Halt permits | No position |
...
| **Abortion** | Maintains ban | Maintains ban; Delia explicitly pro-life | Pro-choice | Pro-choice | Anti-abortion |
| **Euthanasia** | Referendum pledged | Against | Supports | Supports | Against |
| **Immigration** | Managed | Firmer controls | Humanitarian | Balanced | Extreme restriction |
| **Anti-Corruption** | Vitals inquiry ongoing | Delia's hospital concession win is PN's strongest D7 card | Strong | Central | Anti-establishment |

**D7-specific notes:**
- Hunting and trapping is a particularly sensitive D7 issue — the district includes significant agricultural and rural communities where the spring hunting debate has historically had electoral implications.
- Adrian Delia's court victory annulling the Vitals hospital concession is the most concrete documented policy achievement of any opposition figure in recent Maltese parliamentary history. Even with his leadership controversies, this gives him a D7 (and D8) credential.
- Charles Azzopardi (Rabat ex-mayor, Shadow Min. Heritage) has genuine local D7 roots — his presence alongside Rebekah Borg gives PN two credible D7 figures.

## TABLE 7 — FULL MASTER SUMMARY
...
| **Notable** | Julia Farrugia 🏛️ Gov. | Labour | ⭐⭐⭐ | 🟡 | 📡 | ✅ Competitive |
| **Notable** | Adrian Delia | PN | ⭐⭐⭐ | 🔴 | 📡 | ✅ Competitive (D8 primary) |
| **Second-tier** | Anthony Agius Decelis | Labour | ⭐⭐ | 🟢 | 📶 | ✅ Possible |
| **Second-tier** | Malcolm Paul Agius Galea 🏛️ Gov. | Labour | ⭐⭐ | 🟢 | 📶 | ✅ Possible |
| **Second-tier** | Samantha Pace Gasan | Labour | ⭐ | 🟢 | 📵 | ✅ Possible |
| **Second-tier** | Charles Azzopardi | PN | ⭐⭐ | 🟢 | 📶 | ✅ Competitive |
| **Second-tier** | Ian Mario Vassallo | PN | ⭐⭐ | 🟢 | 📶 | ✅ Competitive |
| **Second-tier** | Omar Rababah | Labour | ⭐ | 🟢 | 📶 | ✗ Unlikely |
| **Second-tier** | Andrew Agius | PN | ⭐ | 🟢 | 📵 | ✗ Unlikely |
| **Second-tier** | Paul Mazzola | PN | ⭐ | 🟢 | 📵 | ✗ Unlikely |
...
*Tables compiled 16 May 2026. District 7 historical vote share: Labour ~56–60%, PN ~38–42% (2013–2022). Expected seat split: 3 Labour / 2 PN. Ryan Callus's departure from D7 and Delia's primary move to D8 create significant PN candidate uncertainty; Rebekah Borg is the new PN D7 anchor.*
